      ...
      <Layout title="InnovateHub — Abraham of London Ventures">
        <div className="mx-auto max-w-5xl px-4 py-16 md:py-24">
          ...
          <header className="py-8">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Link
                ...
                className="transform rounded-full bg-green-950 px-6 py-3 font-bold text-white transition-all duration-200 hover:-translate-y-0.5 hover:bg-green-800 hover:shadow-lg"
              >
                Get Early Access
              </Link>
              <Link
                href={AOF_URL}
                className="transform rounded-full border border-gray-200 bg-white px-6 py-3 font-bold text-green-950 transition-all duration-200 hover:-translate-y-0.5 hover:bg-gray-50 hover:shadow-md"
              >
                Abraham of London
              </Link>
            </div>
          ...
          <section className="mt-12">
            <p className="max-w-prose text-lg opacity-95">
          ...
          <section className="mt-16 rounded-3xl border border-gray-100 bg-white p-10 text-center shadow-2xl">
            ...
            <Link
              href={earlyAccessForm}
              className="mt-6 inline-block transform rounded-full bg-green-950 px-8 py-3 text-lg font-bold text-white transition-all duration-200 hover:-translate-y-0.5 hover:bg-green-800 hover:shadow-xl"
            >
              Request Access
            </Link>
          </section>
